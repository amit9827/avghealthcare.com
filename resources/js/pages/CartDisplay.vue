...
>
        ...
        <div class="card-footer">
            ...
            <div class="col-md-2">Amount: ₹{{ cartTotal }} </div>
    ...
    <div class="card mb-3">
       ...
       <div class="card-body">
        <p>
        <input type="checkbox" name="copyshipping" value="1" v-model="copyshipping_option"   @click="copybilling"> Copy from Billing Address</p>
  ...
  export default {
    ...
    copybilling(){
        ...
        this.cartStore.shipping_address = '';
        if(this.copyshipping_option==1)
